...
const PropertyDetails = ({property}) =>{
    ...
    return(
        <section className='propertyDetails'>
            ...
            <AliceCarousel  disableButtonsControls infinite mouseTracking items={items} />
            ...
            {property.seller.name?<a className='link button propertyDetails__connect' href='/home'>Connect with seller </a>: '' }
        </section>
    )
}
